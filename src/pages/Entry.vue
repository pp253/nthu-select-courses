<template>
  <v-container class="entry" style="transform: translateZ(0);">
                ...
                <v-card-title>
                  <div>
                    ...
                    <span class="subheading"
                      >重新設計的選課系統，目標是提供清爽、直覺和方便的選課系統！</span
                    >
                  </div>
                </v-card-title>
                  ...
                  <v-layout wrap>
                    <v-flex xs12 sm6>
                      <v-container pt-0 pl-3 pr-3 pb-3>
                        <h2>📱手機也能輕鬆選課</h2>
                        <p>
                          從此，選課不再是電腦的專利了。清大簡易選課提供適合手機瀏覽的介面，讓你隨時隨地都能選課。
                        </p>
                      </v-container>
                    </v-flex>
                    <v-flex xs12 sm6>
                      <v-container pt-0 pl-3 pr-3 pb-3>
                        <h2>💨快速排志願序</h2>
                        <p>
                          你不再需要為了調整志願序而重複的退選又加選，改用更直覺的方式排志願序吧！
                        </p>
                      </v-container>
                    </v-flex>
                    <v-flex xs12 sm6>
                  ...
                  <v-layout wrap>
                    ...
                    <v-flex xs12 sm6>
                      <v-container pt-0 pl-3 pr-3 pb-3>
                        ...
                        <p>
                          如果你有任何想說的話，請透過<a
                            href="https://goo.gl/forms/TgC3zCe5iYkQ6tyb2"
                            >回饋表單</a
                          >留言！
                        </p>
                      </v-container>
